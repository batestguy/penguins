...
st.write('APP USES 6 INPUTS')
penguin_df=pd.read_csv(r'C:\Users\HP15\Strmlit\streamlit_apps\penguin_app\penguins.csv')
rf_pickle=open(r'C:\Users\HP15\Strmlit\streamlit_apps\penguin_app\randomforest_penguin.pickle','rb')
map_pickle=open(r'C:\Users\HP15\Strmlit\streamlit_apps\penguin_app\output_penguin.pickle','rb')
...
species, the features used in this prediction are ranked by relative importance below.""")
